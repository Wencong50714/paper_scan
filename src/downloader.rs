...
impl PaperDownloader {
    ...
    pub async fn download(&self,
        ...
        let archive_path = output_dir.join(format!("{}.tar.gz", paper_id));
        ...
        println!("Downloaded {} bytes to {}", bytes.len(), archive_path.display());
...
mod tests {
    ...
    async fn test_download_structure() {
        ...
        assert_eq!(
            arxiv_url.src_url,
            "https://arxiv.org/src/2401.08027.tar.gz"
        );
        ...
        assert!(paper_data.archive_path.exists(), "Archive file does not exist");
